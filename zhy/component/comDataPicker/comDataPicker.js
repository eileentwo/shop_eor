/*
  改造来自: https://github.com/rover95/wxapp-timePicker
*/
var now = new Date();
...
Component({
  ...
  externalClasses: ['sensorTypePicker1'],
  /**
   * 组件的属性列表
   */
  properties: {
  ...
  methods: {
    ...
    changeStartDateTime: function(e) {
      ...
      let isStartEnd=this.data.isStartEnd;
      this.compareTime(val,isStartEnd);
    },
